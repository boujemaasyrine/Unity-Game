...
public class QuizManager6 : MonoBehaviour
{
    ...
    public GameObject QuestionMenu6;
    ...
    void SetAnswers()
    {
        ...
        {
            options[i].GetComponent<Image>().color = options[i].GetComponent<AnswerScript6>().startColor;
    ...
    void generateQuestion()
    {
        ...
        {
            QuestionMenu6.gameObject.SetActive(false);
